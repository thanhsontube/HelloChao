...
/**
 * Interface representing either Local or Remote Playback. The {@link ServiceMedia} works
...
public interface MusicPlayback {
    ...
    interface Callback {
        ...
        void onPreparing(MusicItem musicItem);

        void onPlaying (MusicItem musicItem);
         ...
         */
        void onError(MusicItem musicItem, String error);

        void onCurrentPosition(long currentTime);
